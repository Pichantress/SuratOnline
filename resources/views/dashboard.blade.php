<x-app-layout>
    ...
    <div class="flex justify-center p-3">
        <div x-init="links = {{ $user->links->count() }} == 0 ? [{ title: '', url: '' }, ] : {{ $user->links }}" x-data="{
            links: [],
            saved: false,
            ...
            <form class="space-y-6" action="#" @submit.prevent="save">
                                            ...
                                            <g id="Complete">
                                                <g id="minus">
                                                    <line fill="none" stroke="#ffffff" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="2" x1="4"
                                                        x2="20" y1="12" y2="12"></line>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                ...
                <button @click="addField" data-tooltip-target="tooltip-add" data-tooltip-placement="right"
                    ...
                    <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256" width="144px"
                        height="144px" fill-rule="evenodd">
