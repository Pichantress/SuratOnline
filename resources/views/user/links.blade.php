<x-app-layout>
    ...
    <div class="flex justify-center flex-col items-center py-10" >
        <div class="py-5">
            <h1 class="text-5xl font-bold capitalize">Surat Online Desa Bulakan</h1>
        </div>
        ...
        <div
            ...
            <ul class="my-4 space-y-3">
                @foreach ($user->links as $link)
                    <li>
                        @if ($link->file_path)
                            <a href="{{ asset('storage/' . $link->file_path) }}" download="{{ $link->file_name }}"
                                class="flex items-center text-center text-2xl p-3 font-bold text-gray-900 rounded-lg bg-gray-200 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
